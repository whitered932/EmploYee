...
public class Employee : User
{
    ...
    public Employee(
        ...
        long departmentId,
        string phoneNumber,
        DateTime birthDateTime, string departmentTitle) : base(firstName, surname, patronymic, email, password, UserRole.Employee, city, country, name, birthDateTime, phoneNumber)
    {
        Curator = curator;
        Position = position;
    ...
    public string DepartmentTitle { get; private set; }
